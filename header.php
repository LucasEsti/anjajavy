...
<head>
	...
	<meta name="google-site-verification" content="sGDckC3RkXkQf43s-YlpBZ7D2yVnu2smWYhOHAGRETg" />
	<meta name="msvalidate.01" content="EB3C8E6D2587100DF0EE31B385521CBF" />
<?php
	elegant_description();
	elegant_keywords();
	elegant_canonical();
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-BH2S460TXC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-BH2S460TXC');
</script>
</head>
<body <?php body_class(); ?>>
	
	<div id="switch-mobile"><?php do_action('wpml_add_language_selector'); ?></div>
			...
			?>
				<div class="logo_container">
					<span class="logo_helper"></span>
					 <h1  >
                                            <a href="https://www.relaischateaux.com/fr/hotel/anjajavy-le-lodge/" target="_blank">
                                                <img id="logo" alt="Relais chateaux Anjajavy Le Lodge Madagascar" 
                                                     class="logo-relais"
                                                     src="https://anjajavy.com/wp-content/uploads/2023/12/logo-relais-chateaux-blanc.png"
                                                     style="padding-right: 24px; border-right: solid #bf8414 1px;" />
                                            </a>
